...
resource "null_resource" "kubeconfig_admin" {
  # depends_on = ["null_resource.render_certs"]
  triggers  = {
...
// gen csr template api
// gen csr template worker

// ca-key.pem (rsa 2048 root_ca)
//  ca.pem/pub (x509 ssl ca_cert)

// api-server.pem (rsa 2048 api_server_key)
//  csr

// admin.pem/pub (rsa 2048 admin_key)
//  csr

// worker.pem (rsa 2048 worker_key)
//  csr

// dashboard (rsa 2048 dashboard_key)
//  csr
